...
>
> **Current sprint:** INF-009 (Helm chart + K8s readiness/liveness + DR playbook) — promoted after AUTO-009 (browser code coverage mapping — all 10 sub-items 009b/c/d/e/f/g/h/i/j shipped) landed in PR #19. Queue: AI-004 (agent role config schema — dormant) slot 1, AI-005 (multi-agent dispatch — `agentRole` parameter + per-role circuit breakers + per-role telemetry; incl. PR #20 post-ship tripwires for sticky-fallback per-role, planner→codegen handshake, distributed trace ID, pre-run agent health check) slot 2, AI-006 (per-role eval harness extension; incl. PR #20 tripwire for AST-based scorer) slot 3, AI-007 (AI cost governance + budget enforcement; incl. PR #20 tripwires for atomic pre-flight budget check + mid-stream abort) slot 4, AUTO-022b (eval harness recording — deferred pending LLM API key + 4–8h maintainer session) slot 5, AUTO-014 (test dependency + execution ordering) slot 6, DIF-008 (Jira / Linear issue sync) slot 7.
>
> **Blockers:** none remaining · **Remaining:** ~17 planned items across Phases 2–5 + Maintenance (incl. AI-004 through AI-007 remaining on the AI platform foundation track — AI-002 + AI-003 shipped in PR #20 with post-ship tripwires inlined into the AI-005/AI-006/AI-007 sections; see Summary table at the bottom for the authoritative breakdown).
>
> **Recent ships** (newest first; full details in the Completed Work Summary table — never inline implementation prose here, that's what the table is for): AI-002 + AI-003 PR #20 · AUTO-009 PR #19 · MNT-001 + AUTO-022 PR #17 · INF-007 PR #14 · SEC-007 PR #12 · SEC-006 PR #11 · SEC-004 PR #10 · AUTO-008 PR #9 · DIF-015c Gaps 2/3/5/6 PR #8 · AUTO-010 PR #6 · DIF-012 PR #2 · CAP-001 PR #1 · CAP-002 PR #3 · AUTO-004 PR #18 · INT-002b PR #17 · AUTO-001 + INT-002 PR #15 · AI-001 PR #14 · CAP-003 + AUTO-002 + AUTO-002b + AUTO-015 + AUTO-015b PR #12 · DIF-015b Gap 3 + DIF-015c Gap 1 PR #11 · AUTO-003 + AUTO-003b + AUTO-019 PR #10 (legacy) · AUTO-017.3 + PROC-001 + DIF-005 PR #9 (legacy) · CAP-004 + MET-001 + AUTO-017 + UI-REFACTOR-001 PR #8 (legacy). PROC-002 + PROC-003 reverted in PR #10 (legacy).
...
| Phase 5 — Industry Hardening (AUDIT.md) | OTel, Postgres-default, MFA, SSO, PII firewall, eval harness, Helm/DR, SDK, DAG runner, critic agent, **AI platform foundation (AI-002–007)** | 🔄 In progress — SEC-004 MFA ✅ (PR #10), SEC-006 PII firewall ✅ (PR #11), SEC-007 compliance audit log ✅ (PR #12), INF-007 OTel/Sentry observability ✅ (PR #14), AUTO-022 eval harness plumbing ✅ (PR #17 — gate dormant until AUTO-022b records real LLM cache, deferred), **AI-002 provider modularization + AI-003 adapter capability hardening + per-call cost tracking ✅ (PR #20)**; AI-004..AI-007 (agent config → multi-agent dispatch → per-role eval → cost governance) queued (each section inlines the PR #20 post-ship tripwires for its scope). Target: industry-readiness score 6.0/10 → 9.0/10. | 12–16 weeks |
